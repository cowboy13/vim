...
hi4"""
    ...
    def _options_on(self):
        self.send(":set langmap=泄q,褑w,褍e,泻r,械t,薪y,谐u,褕i,褖o,蟹p,褏[,褗],褎a,褘s,胁d,邪f,锌g,褉h,芯j,谢k,写l,卸\\;,褝',褟z,褔x,褋c,屑v,懈b,褌n,褜m,褞.,褢',袡Q,笑W,校E,袣R,袝T,袧Y,袚U,楔I,些O,袟P,啸\{,歇\},肖A,蝎S,袙D,袗F,袩G,袪H,袨J,袥K,袛L,袞\:,协\",携Z,效X,小C,袦V,袠B,孝N,鞋M,袘\<,挟\>\n")
...
class Snippet_With_Umlauts_TypeOn(_UmlautsBase):
    snippets = ('眉l', '眉眉眉眉眉脽脽脽脽')
    keys = 'te 眉l' + EX + "more text"
    wanted = "te 眉眉眉眉眉脽脽脽脽more text"
class Snippet_With_Umlauts_OverwriteFirst(_UmlautsBase):
    snippets = ('眉l', '眉眉 ${1:world} 眉眉 ${2:hello}脽脽\n眉眉眉眉')
    keys = 'te 眉l' + EX + "more text" + JF + JF + "end"
    wanted = "te 眉眉 more text 眉眉 hello脽脽\n眉眉眉眉end"
class Snippet_With_Umlauts_OverwriteSecond(_UmlautsBase):
    snippets = ('眉l', '眉眉 ${1:world} 眉眉 ${2:hello}脽脽\n眉眉眉眉')
    keys = 'te 眉l' + EX + JF + "more text" + JF + "end"
    wanted = "te 眉眉 world 眉眉 more text脽脽\n眉眉眉眉end"
class Snippet_With_Umlauts_OverwriteNone(_UmlautsBase):
    snippets = ('眉l', '眉眉 ${1:world} 眉眉 ${2:hello}脽脽\n眉眉眉眉')
    keys = 'te 眉l' + EX + JF + JF + "end"
    wanted = "te 眉眉 world 眉眉 hello脽脽\n眉眉眉眉end"
class Snippet_With_Umlauts_Mirrors(_UmlautsBase):
    snippets = ('眉l', '眉眉 ${1:world} 眉眉 $1')
    keys = 'te 眉l' + EX + "hello"
    wanted = "te 眉眉 hello 眉眉 hello"
class Snippet_With_Umlauts_Python(_UmlautsBase):
    snippets = ('眉l', '眉眉 ${1:world} 眉眉 `!p snip.rv = len(t[1])*"a"`')
    keys = 'te 眉l' + EX + "h眉眉ll"
    wanted = "te 眉眉 h眉眉ll 眉眉 aaaaa"
